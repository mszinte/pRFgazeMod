...
# Session 1
# ---------
raw_dir_ses1 		= '/home/raw_data/2019/visual/prf_gazemod/sub-001_ses-01_prfGazeMod/'
raw_behav_dir_ses1 	= '/home/raw_data/2019/visual/prf_gazemod/sub-001_behav/ses-01/func/'

bold_files_ses1 =  ["parrec_task-AFGCFS_run-1_bold_20190618091547_4",		# run 01
					"parrec_task-ASGCFS_run-1_bold_20190618091547_6",		# run 02
					"parrec_task-AFGCFS_run-2_bold_20190618091547_8",		# run 03
					"parrec_task-ASGCFS_run-2_bold_20190618091547_10",		# run 04
					"parrec_task-AFGL_run-1_bold_20190618091547_12",		# run 05
					"parrec_task-ASGL_run-1_bold_20190618091547_14",		# run 06
					"parrec_task-AFGR_run-1_bold_20190618091547_16",		# run 07
					"parrec_task-ASGR_run-1_bold_20190618091547_19",		# run 08
					"parrec_task-AFGC_run-1_bold_20190618091547_21",		# run 09
					"parrec_task-ASGC_run-1_bold_20190618091547_23"]		# run 10

epi_files_ses1 =   ["parrec_dir-TU_run-1_epi_20190618091547_5",				# run 01
					"parrec_dir-TU_run-2_epi_20190618091547_7",				# run 02
					"parrec_dir-TU_run-3_epi_20190618091547_9",				# run 03
					"parrec_dir-TU_run-4_epi_20190618091547_11",			# run 04
					"parrec_dir-TU_run-5_epi_20190618091547_13",			# run 05
					"parrec_dir-TU_run-6_epi_20190618091547_15",			# run 06
					"parrec_dir-TU_run-7_epi_20190618091547_17",			# run 07
					"parrec_dir-TU_run-8_epi_20190618091547_20",			# run 08
					"parrec_dir-TU_run-9_epi_20190618091547_22",			# run 09
					"parrec_dir-TU_run-10_epi_20190618091547_24"]			# run 10


bold_physio_files_ses1 =	[	"SCANPHYSLOG20190618092630",				# run 01
								"SCANPHYSLOG20190618093112",				# run 02
								"SCANPHYSLOG20190618093615",				# run 03
								"SCANPHYSLOG20190618094223",				# run 04
								"SCANPHYSLOG20190618095242",				# run 05
								"SCANPHYSLOG20190618095745",				# run 06
								"SCANPHYSLOG20190618100145",				# run 07
								"SCANPHYSLOG20190618100804",				# run 08
								"SCANPHYSLOG20190618101204",				# run 09
								"SCANPHYSLOG20190618101611"]				# run 10

epi_physio_files_ses1 =	[		"SCANPHYSLOG20190618093020",				# run 01
								"SCANPHYSLOG20190618093502",				# run 02
								"SCANPHYSLOG20190618094006",				# run 03
								"SCANPHYSLOG20190618094614",				# run 04
								"SCANPHYSLOG20190618095556",				# run 05
								"SCANPHYSLOG20190618100100",				# run 06
								"SCANPHYSLOG20190618100458",				# run 07
								"SCANPHYSLOG20190618101118",				# run 08
